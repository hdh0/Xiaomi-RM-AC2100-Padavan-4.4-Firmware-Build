...
user_name="root"                                    # 用户名
user_password="qwert1234."                                # 登录密码
lan_ip="192.168.1"                                 # LAN 地址 别写后面的 .1
wlan_2g_ssid="CloseWrt_2.4G"                             # 2G 无线名称
wlan_5g_ssid="CloseWrt_5G"                               # 5G 无线名称
wlan_guest_2g_ssid="CloseWrt_pub_2.4G"                   # 2G 访客无线名称
wlan_guest_5g_ssid="CloseWrt_pub_5G"                     # 5G 访客无线名称
